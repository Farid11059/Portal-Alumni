                ...
                Column(
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: Text("Ahmad Muyassar", style: blackTextFont.copyWith(fontSize: 20, fontWeight: FontWeight.bold), textAlign: TextAlign.center,),
                    ),
                    SizedBox(height: 10,),
                     Container(
                      ...
                      children: <Widget>[
                        Row(
                          children: <Widget>[
                            ...
                            child: Text("yassar.tkj@gmail.com", style: blackTextFont.copyWith(fontSize: 10, fontWeight: FontWeight.bold), textAlign: TextAlign.center,),
                            ),
                     Column(
                        children: <Widget>[
                          Row(
                            children: <Widget>[
                              ...
                              child: Text("yassar.jr", style: blackTextFont.copyWith(fontSize: 10, fontWeight: FontWeight.bold), textAlign: TextAlign.center,),
                            ),
                       Column(
                         children: <Widget>[
                            Row(
                              ...
                              child: Text("Ahmad Muyassar", style: blackTextFont.copyWith(fontSize: 10, fontWeight: FontWeight.bold), textAlign: TextAlign.center,),
                            ),
                          ],
                        ),
                      ],
                        ...
                        children: <Widget>[
                          Container(
                            ...
                            children: <Widget>[
                              ...
                              Text("60200117016", style: blackTextFont.copyWith(fontSize: 14, fontWeight: FontWeight.bold))
                            ],
                          ),),
