                ...
                Column(
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: Text("Muh Rifki Dwi Kurniawan", style: blackTextFont.copyWith(fontSize: 20, fontWeight: FontWeight.bold), textAlign: TextAlign.center,),
                    ),
                    SizedBox(height: 10,),
                     Container(
                      ...
                      children: <Widget>[
                        Row(
                          children: <Widget>[
                            ...
                            child: Text("rifki21@gmail.com", style: blackTextFont.copyWith(fontSize: 10, fontWeight: FontWeight.bold), textAlign: TextAlign.center,),
                            ),
                     Column(
                        children: <Widget>[
                          Row(
                            children: <Widget>[
                              ...
                              child: Text("rifkhy21", style: blackTextFont.copyWith(fontSize: 10, fontWeight: FontWeight.bold), textAlign: TextAlign.center,),
                            ),
                       Column(
                         children: <Widget>[
                            Row(
                              ...
                              child: Text("Muh Rifki Dwi Kurniawan", style: blackTextFont.copyWith(fontSize: 10, fontWeight: FontWeight.bold), textAlign: TextAlign.center,),
                            ),
                          ],
                        ),
                      ],
                        ...
                        children: <Widget>[
                          Container(
                            ...
                            children: <Widget>[
                              ...
                              Text("60200117003", style: blackTextFont.copyWith(fontSize: 14, fontWeight: FontWeight.bold))
                            ],
                          ),),
                    ...
                    Container(
                      ...
                      children: <Widget>[
                        ...
                        Text("Jl. Macandaa", style: blackTextFont.copyWith(fontSize: 14, fontWeight: FontWeight.bold))
                      ],
                    ),),
                    SizedBox(height: 10,),
                    Container(
                    ...
                    Container(
                      ...
                      children: <Widget>[
                        ...
                        Text("Poso, 03 Agustus 1999", style: blackTextFont.copyWith(fontSize: 14, fontWeight: FontWeight.bold))
                      ],
                    ),),
                    SizedBox(height: 10,),
                    Container(
